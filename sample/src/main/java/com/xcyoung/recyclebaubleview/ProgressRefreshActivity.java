...
import com.xcyoung.recyclebauble.header.ProgressRefreshView;
...
public class ProgressRefreshActivity extends AppCompatActivity {
    @BindView(R.id.list)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        baubleView.addItemDecoration(new SpacesItemDecoration(30,30));
        baubleView.setRefreshView(new ProgressRefreshView(this));
